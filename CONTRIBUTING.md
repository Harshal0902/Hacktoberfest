...
**1.**  Fork [this](https://github.com/Harshal0902/Hacktoberfest) repository.

**2.**  Clone your forked copy of the project.

```
git clone --depth 1 https://github.com/<your_user_name>/Hacktoberfest.git
```
...
```
git remote add upstream https://github.com/Harshal0902/Hacktoberfest.git 
```
